package com.daemon.aop;

import com.alibaba.fastjson.JSON;
import com.daemon.annotation.OperationLogDetail;
import com.daemon.model.OperationLog;
...
public class LogAspect {
     ...
     * '@Pointcut("execution(* com.daemon.service.impl.*.*(..))")'
     */
    @Pointcut("@annotation(com.daemon.annotation.OperationLogDetail)")
